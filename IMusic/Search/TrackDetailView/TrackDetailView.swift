...
//  IMusic
//
//  Created by Светлана Шардакова on 27.06.2020.
...
class TrackDetailView: UIView {
    ...
    @IBOutlet weak var miniImageTrackView: UIImageView!
    ...
    func set(viewModel: SearchViewModel.Cell) {
        ...
        miniImageTrackView.sd_setImage(with: url, completed: nil)
    ...
    private func playTrack(previewUrl: String?) {
        print("try to play track with previewUrl")
